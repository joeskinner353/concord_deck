...
export class ZoomableSection {
    ...
    showSubsectionContent(sectionId) {
        try {
            ...
            const featuredWorksHtml = section.videos ? `
                    ...
                    <div class="video-grid">
                        ${section.videos.map(video => {
                            const videoEmbed = video.type === 'youtube' 
                                ...
                                : `<iframe src="https://player.vimeo.com/video/${video.id}" width="100%" height="315" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>`;
            ...
            // Add a loading state for the playlist
            const playlistHtml = section.discoPlaylistEmbed ? `
                <div class="playlist-container">
                    <div class="playlist-loading">Loading playlist...</div>
                    ${section.discoPlaylistEmbed}
                </div>
            ` : '<div class="playlist-placeholder">Playlist coming soon...</div>';
                    ...
                    <div class="composer-header">
                        ...
                        <div class="composer-title-wrapper">
                            <div class="title-container">
                                <h2>${section.title}</h2>
                                <div class="artist-list">Rihanna, J Hus, Wretch 32, Poppy Ajudha, Miraa May</div>
                            </div>
                            ${socialLinks}
                        </div>
                    </div>
